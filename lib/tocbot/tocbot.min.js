!function (e) {
    ...
    (function (o) {
        ...
        !function (n, o) {
            ...
            function o(e, t, n) {
                ...
                var o, l;
                return function () {
                    var i = n || this, r = +new Date, s = arguments;
                    o && r < o + t ? (clearTimeout(l), l = setTimeout(function () {
                        o = r, e.apply(i, s)
                    }, t)) : (o = r, e.apply(i, s))
                }
            }
            ...
            if ("undefined" != typeof window) {
                ...
                return c.destroy = function () {
                    ...
                    if (f && (s = t(r, e || {}), this.options = s, this.state = {}, s.scrollSmooth && (c.scrollSmooth = n(5).initSmoothScrolling({duration: s.scrollSmoothDuration})), l = a(s), i = u(s), this._buildHtml = l, this._parseContent = i, c.destroy(), null !== (d = i.selectHeadings(s.contentSelector, s.headingSelector)))) {
                        var m = i.nestHeadingsArray(d), h = m.nest;
                        return l.render(s.tocSelector, h), this._scrollListener = o(function (e) {
                            l.updateToc(d);
    ...
    function n(e) {
        ...
        var i = e.duration, r = location.hash ? n(location.href) : location.href;
        !function () {
            function e(e) {
                !t(e.target) || e.target.className.indexOf("no-smooth-scroll") > -1 || "#" === e.target.href.charAt(e.target.href.length - 2) && "!" === e.target.href.charAt(e.target.href.length - 1) || (e.preventDefault(), o(e.target.hash, {
                    duration: i,
                    callback: function () {
                        l(e.target.hash)
                    }
    ...
    function o(e, t) {
        ...
        function o() {
            window.scrollTo(0, s + u - 72), "function" == typeof c.callback && c.callback()
        }
